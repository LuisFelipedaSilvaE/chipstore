...
<aside>
  ...
  <nav
    id="sidebar"
    class="fixed overflow-auto scrollbar-none top-0 right-full lg:sticky lg-top-0 w-screen sm:w-4/5 lg:w-100 h-screen flex flex-col bg-[var(--sidebar-bg-color)] border-r border-r-gray-800 transition-all duration-300 ease-in-out lg:translate-x-0 z-10">
    <div id="sidebar-header" class="sidebar-header flex items-center justify-center p-3 lg:pr-3 gap-2">
      <div
        ...
        <img class="w-10.5 h-10.5" src="/images/icon.svg" alt="" />
      </div>
      ...
      <div id="collapse-side-bar" class="flex items-center justify-end flex-1">
        <i class="inline-flex bi bi-layout-sidebar cursor-pointer rounded hover:bg-[var(--main-bg-color)] text-lg p-3 transition-colors"></i>
      </div>
      <div id="uncollapse-side-bar" class="hidden items-center justify-end">
        <i class="inline-flex bi bi bi-layout-sidebar-reverse cursor-pointer rounded hover:bg-[var(--main-bg-color)] text-lg p-3 transition-colors"></i>
      </div>
      ...
      <ul class="list-none flex flex-col gap-2">
        ...
        <li class="sidebar-item rounded-lg transition-all cursor-pointer">
          <a class="flex-1 p-3 flex gap-2" href="/view/modules/produto/">
            <i
              class="[display:inline-flex!important] sidebar-icon fa fa-box basis-5 justify-center items-center"></i>
        ...
        <li class="sidebar-item rounded-lg transition-all cursor-pointer">
          <a class="flex-1 p-3 flex gap-2" href="/view/modules/cliente/">
            <i
              class="[display:inline-flex!important] sidebar-icon fa fa-user-group basis-5 justify-center items-center"></i>
        ...
        <li class="sidebar-item rounded-lg transition-all cursor-pointer">
          <a class="flex-1 p-3 flex gap-2" href="/view/modules/pedido/">
            <i
              class="[display:inline-flex!important] sidebar-icon fa fa-cart-shopping basis-5 justify-center items-center"></i>
